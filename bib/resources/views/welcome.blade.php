...
{{--                        <p style=" font-size: 50px; font-weight: bold; text-align: center; ">BakedInBombay</p>--}}
{{--                        <medium>#ExperimentalBaking</medium>--}}
{{--                        <p></p>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                                <span style="text-decoration: underline">Order</span>--}}
{{--                            </a>--}}
...
{{--                                Sponsor--}}
{{--                            </a>--}}
{{--                            <a href="https://www.instagram.com/bakedinbombay/" class="ml-1">--}}
{{--                                <i class="fa fa-instagram" aria-hidden="true" style="font-size: 18px;"></i>--}}
{{--                                <span style="text-decoration: underline">Reach us</span>--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}

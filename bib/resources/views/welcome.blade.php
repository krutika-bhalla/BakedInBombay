            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><a class="btn btn-lg btn-circle btn-outline-new-white" href="{{route('home')}}">Order Now</a></p>
                    </div>
                </div>
            </div>
        </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                <div class="inner-column">
                    ...
                    <a class="btn btn-lg btn-circle btn-outline-new-white" style="margin-bottom: 20px" href="{{route('home')}}">Order Now</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12">
                <p align="center">
